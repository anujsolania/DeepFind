    ...
    <div className="flex h-screen w-screen bg-[#090B11] text-zinc-100 font-sans overflow-hidden">
      ...
      <aside className="w-64 bg-[#0d0e12] border-r border-zinc-800 flex flex-col justify-between p-4 shrink-0">
        ...
        <div className="flex flex-col gap-6">
          ...
          <button className="w-full py-2.5 px-4 bg-zinc-800 hover:bg-zinc-700/80 rounded-xl font-medium transition duration-200 text-sm cursor-pointer border border-zinc-700 text-zinc-200 hover:text-zinc-100">
            + New Chat
          </button>
